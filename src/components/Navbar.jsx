    ...
    <header className={`navbar-header ${isScrolled ? 'scrolled glass-panel' : ''}`}>
      <nav className="container navbar">
        ...
        <div className="nav-links desktop-nav">
          ...
          <motion.a 
            href={`${import.meta.env.BASE_URL}Certificates/Parthiban V.pdf`}
            target="_blank"
      ...
      {mobileMenuOpen && (
        <div className="mobile-menu glass-panel">
          ...
          <a href={`${import.meta.env.BASE_URL}Certificates/Parthiban V.pdf`} target="_blank" rel="noopener noreferrer" className="resume-btn font-mono" style={{ marginTop: '1rem', display: 'inline-block' }}>
            Resume
          </a>
        </div>
      )}
