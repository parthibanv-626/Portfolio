    ...
    <header className={`navbar-header ${isScrolled ? 'scrolled glass-panel' : ''}`}>
      <nav className="container navbar">
        ...
        <div className="nav-links desktop-nav">
          ...
          <motion.a 
            href="https://drive.google.com/file/d/1EubBWqAohVFNnhm6S_iaElRivlw3bUmV/view?usp=drive_link"
            target="_blank"
      ...
      {mobileMenuOpen && (
        <div className="mobile-menu glass-panel">
          ...
          <a href="https://drive.google.com/file/d/1EubBWqAohVFNnhm6S_iaElRivlw3bUmV/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="resume-btn font-mono" style={{ marginTop: '1rem', display: 'inline-block' }}>
            Resume
          </a>
        </div>
      )}
